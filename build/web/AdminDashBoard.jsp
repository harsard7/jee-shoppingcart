<%-- 
    ...
    Created on : Jun 22, 2018, 7:12:18 PM
    Author     : Hafees
--%>
                        ...
                        <div class="card">
                            ...
                            <div class="content">
                                <form action="CustomerServletController" method="post">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" placeholder="Re enter The Password" name="confirmpassword" >
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label>Contact</label>
                                                <input type="text" class="form-control" placeholder="Last Name"  name="contact">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                    ...
                                    <button type="submit" class="btn btn-info btn-fill pull-right">Save Customer</button>
