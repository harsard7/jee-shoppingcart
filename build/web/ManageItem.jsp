...
<%@page import="com.ijse.shoppingcart.DTO.CategoryDTO"%>
<%@page import="java.util.List"%>
<%@page import="com.ijse.shoppingcart.service.custom.CategoryService"%>
                    ...
                    <div class="col-md-8">
                        <div class="card">
                            <div class="header">
                                ...
                                <div>
                                    <%
//                                        out.print(request.getSession().getAttribute("listcategory"));
        CategoryService categoryService =(CategoryService)ServiceFactory.getInstance().getService(CONSTANTSTYPE.CATEGORY);
        List<CategoryDTO>catlist=categoryService.showAll();
        ...
        %>
           ...
           <% if(request.getParameter("status")!=null){
            ...
            %> 
                     <h2 style="color: green">Item Saved</h2>
            <%
                        }else if(request.getParameter("status").equals("2")){
            %>
                      <h2 style="color:red">Item Not Saved</h2>
            <%
                }     
             }
            %>
                            ...
                            <div class="content">
                                <form action="ItemServletController" method="post">
                                    <div class="row">
                                        <div class="col-md-5">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" id="sel1" name="category">
                                                <c:forEach items="${catlist}" var="catergory"> 
